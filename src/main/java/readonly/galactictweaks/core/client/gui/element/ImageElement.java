...
public class ImageElement extends GuiElement {
	 ...
	 */
	public ImageElement(int x, int y, int width, int height, String imageURL) {
	 ...
	 * @param imageURL URL to image
	 */
	public ImageElement(int x, int y, int width, int height, URL imageURL) {
	 ...
	 */
	public ImageElement(int x, int y, int width, int height, File imageFile) {
		super(x, y, width, height);
		BufferedImage img;
		try {
	 ...
	 */
	public ImageElement(int x, int y, int width, int height, ResourceLocation resourceLocation) {
		super(x, y, width, height);
		image = null;
