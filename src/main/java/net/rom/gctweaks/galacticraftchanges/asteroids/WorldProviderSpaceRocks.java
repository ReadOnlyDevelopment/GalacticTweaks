...
public class WorldProviderSpaceRocks extends WorldProviderSpace implements ISolarLevel {
	...
	public CelestialBody getCelestialBody () {
		return EditableAsteroids.abelt;
	}
	...
	public Class<? extends IChunkGenerator> getChunkProviderClass () {
		return ChunkProviderGCTAsteroids.class;
	}
