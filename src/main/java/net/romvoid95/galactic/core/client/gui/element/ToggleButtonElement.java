...
public class ToggleButtonElement extends ButtonElement {
	...
	/**
	 * Creates an new ToggleButtonElement
	 *
	 * @param xPos          X positon
	 * @param yPos          Y Position
	 * @param displayString Button Text
	 */
	public ToggleButtonElement(int xPos, int yPos, String displayString) {
	 ...
	 */
	public ToggleButtonElement(int xPos, int yPos, int width, String displayString) {
	 ...
	 */
	public ToggleButtonElement(int xPos, int yPos, int width, String displayString, ResourceLocation icon) {
	 ...
	 */
	public ToggleButtonElement(int xPos, int yPos, int width, int height, String displayString) {
	 ...
	 * @param height        Button Height
	 */
	public ToggleButtonElement(int xPos, int yPos, int width, int height, String displayString, ResourceLocation icon) {
	 ...
	 * @param icon Resource Location for an icon
	 */
	public ToggleButtonElement(int xPos, int yPos, String string, ResourceLocation icon) {
	 ...
	 */
	public ToggleButtonElement(int xPos, int yPos, ResourceLocation onIcon, ResourceLocation offIcon) {
	...
	public enum DrawType {
		...
		COLORED_LINE,
		/**
		 * Draws an specified string after the display string Or toggles the icons
		 */
		STRING_OR_ICON,
		/**
