package net.romvoid95.gctweaks.gc.features.buggy.client;
...
public class RenderBuggy extends Render<EntityTeamBuggy>
{
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityTeamBuggy entity)
    {
        return TextureMap.LOCATION_BLOCKS_TEXTURE;
    }

    @Override
    public void doRender(EntityTeamBuggy entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Override
    public boolean shouldRender(EntityTeamBuggy buggy, ICamera camera, double camX, double camY, double camZ)
    {
